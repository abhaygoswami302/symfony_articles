...
class __TwigTemplate_805504ec98501ad3b2bcde6907edb1e790871a59159e11c75a6299fe93da4e89 extends Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["post"]) {
            ...
            echo "
                ...
                <td>
                    ";
            // line 47
            if (twig_get_attribute($this->env, $this->source, $context["post"], "category", [], "any", false, false, false, 47)) {
                // line 48
                echo "                    ";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "category", [], "any", false, false, false, 48), "html", null, true);
                echo "
                    ";
            } else {
                // line 50
            ...
            echo "                </td>
                <td>
                    ";
            // line 54
            if (twig_get_attribute($this->env, $this->source, $context["post"], "image", [], "any", false, false, false, 54)) {
                // line 55
                echo "                     <img src=\"";
                echo twig_escape_filter($this->env, ("/uploads/" . twig_get_attribute($this->env, $this->source, $context["post"], "image", [], "any", false, false, false, 55)), "html", null, true);
                echo "\" style=\"width:100px;height:80px\" />
                    ";
            } else {
                // line 57
                echo "                        N/A
            ...
            echo "                </td>
                ...
                <a href=\"";
            // line 62
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("post.show", ["id" => twig_get_attribute($this->env, $this->source, $context["post"], "id", [], "any", false, false, false, 62)]), "html", null, true);
            echo "\">
                    <lord-icon
                ...
                <a href=\"";
            // line 77
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("post.delete", ["id" => twig_get_attribute($this->env, $this->source, $context["post"], "id", [], "any", false, false, false, 77)]), "html", null, true);
            echo "\">
                    <lord-icon
...
";
    ...
    {
        return array (  226 => 88,  209 => 77,  191 => 62,  186 => 59,  182 => 57,  176 => 55,  174 => 54,  170 => 52,  166 => 50,  160 => 48,  158 => 47,  152 => 44,  147 => 42,  144 => 41,  140 => 40,  126 => 28,  117 => 25,  114 => 24,  110 => 23,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
    ...
    <div class=\"col-sm-8 offset-2 mt-4\">
        ...
        <table class=\"table table-striped table-hover mb-4\" style=\"background:#f8f9f4;border:1px solid lightgray;\">
            ...
            <tbody>
                ...
                <td>
                    {% if(post.image) %}
                     <img src=\"{{ '/uploads/' ~ post.image }}\" style=\"width:100px;height:80px\" />
                    {% else %}
                        N/A
                    {% endif %}
                </td>
